...
<script type="text/javascript">
	...
	function toPage(pageIndex)
	{
	    ...
	    $("#noticeform").attr("action", "${ctx}/notice/noticelist.action");
		$("#noticeform").submit();
	}
 	   ...
 	   $("#delete").click(function(){
 		   ...
 		   if(checkedBoxs.length < 1){
 			   alert("请选择一个需要删除的用户！");
 			    ...
 			    $("#noticeform").attr("action", "${ctx}/notice/noticedel.action");
 		 		$("#noticeform").submit();
 		   }
 	   })
			...
			<tr valign="top">
				<td height="20">
					<table width="100%" border="1" cellpadding="5" cellspacing="0"
						...
						<c:forEach items="${pageModel.list}" var="notice"
							varStatus="stat">
							<tr id="data_${stat.index}" align="center" class="main_trbg"
								...
								<td align="center" width="40px;"><a
									href="${ctx}/notice/updateNotice.action?id=${notice.id}"> <img
